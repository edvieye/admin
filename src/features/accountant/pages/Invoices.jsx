    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark">
      ...
      <div className="ml-64 p-8">
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-primary/5 shadow-sm p-8 text-center">
          <span className="material-icons text-6xl text-slate-300 mb-4">receipt</span>
          <h3 className="text-lg font-medium text-slate-700 dark:text-slate-300 mb-2">Invoice Management</h3>
          <p className="text-slate-500 mb-6">This page will list all invoices, allow creation, filtering, and exports.</p>
