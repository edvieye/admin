...
const AccountantModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Accountant Data:", formData);
    onClose();
  };
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-slate-900 w-full max-w-4xl rounded-2xl shadow-xl p-6 overflow-y-auto max-h-[90vh]">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold">Add Accountant</h2>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <input name="designation" placeholder="Designation (e.g. Senior Accountant)" className="input" onChange={handleChange} />
          ...
          <input name="experience" placeholder="Experience (e.g. 5 Years)" className="input" onChange={handleChange} />
          ...
          {/* Bank Details */}
          <h3 className="col-span-1 md:col-span-2 font-semibold mt-4">Bank Details</h3>
          ...
          <input name="ifscCode" placeholder="IFSC Code" className="input" onChange={handleChange} />
